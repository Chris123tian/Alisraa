    ...
    <>
      ...
      <section className="py-12 md:py-20 bg-background overflow-hidden">
        <div className="container mx-auto px-4">
          {/* Main Hero Image */}
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] w-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden mb-12 md:mb-20 shadow-2xl group animate-in fade-in zoom-in duration-1000">
            <Image 
              src={mainAboutImg}
            ...
            <div className="absolute inset-0 flex items-center px-6 md:px-16">
              <div className="max-w-xl text-white space-y-4 md:space-y-6 animate-in slide-in-from-left duration-700 delay-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-16 md:mb-24">
            {aboutContent.map((item, idx) => (
              <Card key={item.title} className="group border-none shadow-xl rounded-[1.5rem] md:rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 bg-card flex flex-col animate-in fade-in slide-in-from-bottom-12 duration-700" style={{ animationDelay: `${idx * 200}ms` }}>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <CardContent className="px-6 md:px-8 pb-6 md:pb-8 flex-grow flex flex-col justify-between">
                    ...
                    {item.learnMore && (
                      <Button variant="outline" className="w-full sm:w-fit rounded-full border-2 border-primary text-primary font-bold hover:bg-primary hover:text-white px-8 h-12 transition-all group-hover:bg-primary group-hover:text-white">
                        {t.about.learnMore}
                      </Button>
                    )}
                  </CardContent>
          ...
          {/* Schedule Section */}
          <div className="bg-primary rounded-[2rem] md:rounded-[4rem] p-8 md:p-24 text-white relative overflow-hidden text-center shadow-3xl animate-in slide-in-from-bottom duration-1000">
            ...
            <div className="relative z-10 max-w-5xl mx-auto space-y-8 md:space-y-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 pt-4">
                {vesselSchedule.map((item, i) => (
                  <div key={item} className="p-6 md:p-12 bg-white/5 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2.5rem] border border-white/10 hover:bg-accent hover:border-accent hover:scale-105 transition-all group cursor-default shadow-lg animate-in zoom-in duration-500" style={{ animationDelay: `${i * 150}ms` }}>
