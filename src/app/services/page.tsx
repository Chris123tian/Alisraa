      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-primary mb-6">{t.services.transparentPricing}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {shippingRates.map((rate, idx) => (
              <Card key={rate.destination} className="flex flex-col border-none shadow-2xl rounded-3xl overflow-hidden hover:shadow-primary/10 transition-shadow">
                <div className="h-64 relative">
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-3xl font-black uppercase tracking-tighter">{t.services.goodsTo} {rate.destination}</h3>
                  </div>
                </div>
                
                <CardContent className="flex-grow p-8 space-y-8">
                  <div className="space-y-4">
                    <h4 className="font-bold text-xl flex items-center gap-2 text-primary">
                      <div className="w-1 h-6 bg-accent rounded-full" />
                      {t.services.ocean}
                    </h4>
                    <div className="bg-muted/30 rounded-2xl overflow-hidden border border-primary/5">
                      <Table>
                        <TableHeader>
                        ...
                        <TableBody>
                          {rate.ocean.map((option) => (
                            <TableRow key={option.duration}>
                              ...
                              <TableCell className="text-right font-black text-accent">{option.cost}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
